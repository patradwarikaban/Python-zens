...
from src.te_utils.helpers import to_json_response, version_tuple
from src.te_utils.response import ErrorResponse
from src.te_utils.settings import MIN_VERSION
...
def check_version():
    ...
    # version = request.headers.get("X-TemplateEngine-Api-Version", None)
    # if not version:
    #     return (
    #         to_json_response(
    #             ErrorResponse(description="No TemplateEngine-Api-Version found.")
    #         ),
    #         HTTPStatus.BAD_REQUEST,
    #     )
    ...
    #         to_json_response(
    #             ErrorResponse(
    #                 description="TemplateEngine requires version %d.%d+." % MIN_VERSION
    #             )
    #         ),
