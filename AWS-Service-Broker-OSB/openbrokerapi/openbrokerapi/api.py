...
def get_blueprint(
    ...
    def last_operation(instance_id):
        ...
        try:
            ...
            return (
                to_json_response(LastOperationResponse(OperationState.SUCCEEDED, "Instance does not exist")),
                HTTPStatus.NOT_FOUND,
            )
        except errors.ErrInstanceDeleted:
            return (
                to_json_response(LastOperationResponse(OperationState.SUCCEEDED, "Instance Deleted")),
                HTTPStatus.GONE,
            )
